...
<center><h3 style="font-size:50px;">图书信息</h3></center>  
  <body  style="background-image: url(images/backImage.jpg)">
  <%String name=request.getParameter("username"); %>
  当前用户<%=name %>
  <center>
<form action="borrowOne" method ="post">
...
状态：可供出借<input type="hidden" name="n.stock" value="<s:property value='n.stock-1'/>"/><br>
